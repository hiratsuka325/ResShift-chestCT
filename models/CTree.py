...
def loss_maxima(graph, image, saliency_measure, importance_measure, num_target_maxima, p=0.5, q=2):
  """
  ...
  return loss_ranked_selection(saliency, importance, num_target_maxima, p, q)